namespace KBEngine
{
    ...
    public class Monster : MonsterBase
    {
		...
		{
			// KBELog.DEBUG_MSG(className + "::recvDamage: attackerID=" + attackerID + ", skillID=" + skillID + ", damageType=" + damageType + ", damage=" + damage);
		...
		{
			// KBELog.DEBUG_MSG(className + "::set_state: " + old + " => " + v); 
